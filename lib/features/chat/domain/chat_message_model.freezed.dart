...
class _$ChatMessageImpl with DiagnosticableTreeMixin implements _ChatMessage {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ChatMessage(id: $id, chatRoomId: $chatRoomId, senderEmail: $senderEmail, message: $message, timestamp: $timestamp)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, chatRoomId, senderEmail, message, timestamp);
